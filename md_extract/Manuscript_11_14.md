...
[![](md_extract/assets/fig-IGAS-Training1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-IGAS-Training1-1.png)
...
[![](md_extract/assets/fig-IGAS-Testing1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-IGAS-Testing1-1.png)
...
[![](md_extract/assets/fig-e2test1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e2test1-1.png)
...
[![](md_extract/assets/fig-taskSpace1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-taskSpace1-1.png)
...
Table 4: Testing Deviation - Empirical Summary
...
Descriptive summaries testing deviation data are provided in [Table 4](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e1-test-nf-deviation) and [Figure 12](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#fig-e1-test-dev). To model differences in accuracy between groups, we used Bayesian mixed effects regression models to the trial level data from the testing phase. The primary model predicted the absolute deviation from the target velocity band (dist) as a function of training condition (condit), target velocity band (band), and their interaction, with random intercepts and slopes for each participant (id).
...
[![](md_extract/assets/fig-e1-test-dev-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-test-dev-1.png)

Figure 12: E1. Deviations from target band during testing without feedback stage.

Table 5: Experiment 1. Bayesian Mixed Model predicting absolute deviation as a function of condition (Constant vs. Varied) and Velocity Band
...
The model predicting absolute deviation (dist) showed clear effects of both training condition and target velocity band (Table X). Overall, the varied training group showed a larger deviation relative to the constant training group (β = 157.44, 95% CI \[60.53, 254.9\]). Deviation also depended on target velocity band, with lower bands showing less deviation. See [Table 5](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e1-bmm-dist) for full model output.

##### Discrimination between bands

In addition to accuracy/deviation, we also assessed the ability of participants to reliably discriminate between the velocity bands (i.e. responding differently when prompted for band 600-800 than when prompted for band 150-350). [Table 6](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e1-test-nf-vx) shows descriptive statistics of this measure, and Figure 1 visualizes the full distributions of throws for each combination of condition and velocity band. To quantify discrimination, we again fit Bayesian Mixed Models as above, but this time the dependent variable was the raw x velocity generated by participants on each testing trial.
...
[![](md_extract/assets/fig-e1-test-vx-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-test-vx-1.png)

Figure 13: E1 testing x velocities. Translucent bands with dash lines indicate the correct range for each velocity band.

Table 6: Testing vx - Empirical Summary
...
Table 7: Experiment 1. Bayesian Mixed Model Predicting Vx as a function of condition (Constant vs. Varied) and Velocity Band
...
See [Table 7](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e1-bmm-vx) for the full model results. The estimated coefficient for training condition (\\(B\\) = 164.05, 95% CrI \[45.5, 278.85\]) suggests that the varied group tends to produce harder throws than the constant group, but is not in and of itself useful for assessing discrimination. Most relevant to the issue of discrimination is the slope on Velocity Band (\\(B\\) = 0.71, 95% CrI \[0.62, 0.8\]). Although the median slope does fall underneath the ideal of value of 1, the fact that the 95% credible interval does not contain 0 provides strong evidence that participants exhibited some discrimination between bands. The estimate for the interaction between slope and condition (\\(B\\) = -0.14, 95% CrI \[-0.26, -0.01\]), suggests that the discrimination was somewhat modulated by training condition, with the varied participants showing less senitivity between vands than the constant condition. This difference is depicted visually in **?@fig-e1-bmm-vx.Slope** coefficients are broken down by quartile in [Table 8](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e1-slope-quartile). The constant participant participants appear to have larger slopes across quartiles, but the difference between conditions may be less pronounced for the top quartiles of subjects who show the strongest discrimination. Figure [Figure 15](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#fig-e1-bmm-bx2) shows the distributions of slope values for each participant, and the compares the probability density of slope coefficients between training conditions. [Figure 16](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#fig-e1-indv-slopes)
...
[![](md_extract/assets/fig-e1-bmm-vx-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-bmm-vx-1.png)

(a) Model fit to all 6 bands

[![](md_extract/assets/fig-e1-bmm-vx-2.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-bmm-vx-2.png)
...
Table 8: Slope coefficients by quartile, per condition

| Condition | Q\_0%\_mean | Q\_25%\_mean | Q\_50%\_mean | Q\_75%\_mean | Q\_100%\_mean |
| --- | --- | --- | --- | --- | --- |
| Constant | \-0.109 | 0.482 | 0.691 | 0.932 | 1.40 |
| Varied | \-0.198 | 0.268 | 0.584 | 0.901 | 1.31 |

[![](md_extract/assets/fig-e1-bmm-bx2-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-bmm-bx2-1.png)

(a) Slope estimates by participant - ordered from lowest to highest within each condition.

[![](md_extract/assets/fig-e1-bmm-bx2-2.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-bmm-bx2-2.png)

(b) Destiny of slope coefficients by training group

Figure 15: Slope distributions between condition

[![](md_extract/assets/fig-e1-indv-slopes-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-indv-slopes-1.png)

(a) subset with largest slopes

[![](md_extract/assets/fig-e1-indv-slopes-2.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-indv-slopes-2.png)

(b) subset with smallest slopes

Figure 16: Subset of Varied and Constant Participants with the smallest and largest estimated slope values. Red lines represent the best fitting line for each participant, gray lines are 200 random samples from the posterior distribution. Black points and intervals at each band represent the estimated median and 95% HDI. Blue points are empirical means.

## Experiment 2

[Figure 17](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#fig-design-e2) illustrates the design of Experiment 2. The stages of the experiment (i.e. training, testing no-feedback, test with feedback), are identical to that of Experiment 1. The only change is that Experiment 2 participants train, and then test, on bands in the reverse order of Experiment 1 (i.e. training on the softer bands; and testing on the harder bands).
...
Descriptive summaries testing deviation data are provided in [Table 9](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e2-test-nf-deviation) and [Figure 18](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#fig-e2-test-dev). To model differences in accuracy between groups, we used Bayesian mixed effects regression models to the trial level data from the testing phase. The primary model predicted the absolute deviation from the target velocity band (dist) as a function of training condition (condit), target velocity band (band), and their interaction, with random intercepts and slopes for each participant (id).

\\\[\\begin{equation} dist\_{ij} = \\beta\_0 + \\beta\_1 \\cdot condit\_{ij} + \\beta\_2 \\cdot band\_{ij} + \\beta\_3 \\cdot condit\_{ij} \\cdot band\_{ij} + b\_{0i} + b\_{1i} \\cdot band\_{ij} + \\epsilon\_{ij} \\end{equation}\\\]

Table 9: Testing Deviation - Empirical Summary
...
[![](md_extract/assets/fig-e2-test-dev-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e2-test-dev-1.png)

Figure 18: E2. Deviations from target band during testing without feedback stage.

Table 10: Experiment 2. Bayesian Mixed Model predicting absolute deviation as a function of condition (Constant vs. Varied) and Velocity Band
...
In addition to accuracy/deviation. We also assessed the ability of participants to reliably discriminate between the velocity bands (i.e. responding differently when prompted for band 600-800 than when prompted for band 150-350). [Table 11](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e2-test-nf-vx) shows descriptive statistics of this measure, and Figure 1 visualizes the full distributions of throws for each combination of condition and velocity band. To quantify discrimination, we again fit Bayesian Mixed Models as above, but this time the dependent variable was the raw x velocity generated by participants.

\\\[\\begin{equation} vx\_{ij} = \\beta\_0 + \\beta\_1 \\cdot condit\_{ij} + \\beta\_2 \\cdot bandInt\_{ij} + \\beta\_3 \\cdot condit\_{ij} \\cdot bandInt\_{ij} + b\_{0i} + b\_{1i} \\cdot bandInt\_{ij} + \\epsilon\_{ij} \\end{equation}\\\]

[![](md_extract/assets/fig-e2-test-vx-1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e2-test-vx-1.png)

Figure 19: E2 testing x velocities. Translucent bands with dash lines indicate the correct range for each velocity band.

Table 11: Testing vx - Empirical Summary
...
Table 12: Experiment 2. Bayesian Mixed Model Predicting Vx as a function of condition (Constant vs. Varied) and Velocity Band
...
See [Table 12](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e2-bmm-vx) for the full model results.
...
[![](md_extract/assets/fig-e2-bmm-vx-1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e2-bmm-vx-1.png)

Figure 20: Conditional effect of training condition and Band. Ribbons indicate 95% HDI.
...
Descriptive summaries testing deviation data are provided in [Table 13](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e3-test-nf-deviation) and [Figure 21](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#fig-e3-test-dev). To model differences in accuracy between groups, we fit Bayesian mixed effects regression models to the trial level data from the testing phase. The primary model predicted the absolute deviation from the target velocity band (dist) as a function of training condition (condit), target velocity band (band), and their interaction, with random intercepts and slopes for each participant (id).

Table 13: Testing Deviation - Empirical Summary
...
[![](md_extract/assets/fig-e3-test-dev-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e3-test-dev-1.png)

Figure 21: e3. Deviations from target band during testing without feedback stage.

Table 14: Experiment 3. Bayesian Mixed Model predicting absolute deviation as a function of condition (Constant vs. Varied) and Velocity Band
...
[![](md_extract/assets/fig-e3-bmm-dist-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e3-bmm-dist-1.png)

Figure 22: e3. Conditioinal Effect of Training Condition and Band. Ribbon indicated 95% Credible Intervals.

##### Discrimination between Velocity Bands

In addition to accuracy/deviation. We also assessed the ability of participants to reliably discriminate between the velocity bands (i.e. responding differently when prompted for band 600-800 than when prompted for band 150-350). [Table 15](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e3-test-nf-vx) shows descriptive statistics of this measure, and Figure 1 visualizes the full distributions of throws for each combination of condition and velocity band. To quantify discrimination, we again fit Bayesian Mixed Models as above, but this time the dependent variable was the raw x velocity generated by participants.

\\\[\\begin{equation} vx\_{ij} = \\beta\_0 + \\beta\_1 \\cdot condit\_{ij} + \\beta\_2 \\cdot bandInt\_{ij} + \\beta\_3 \\cdot condit\_{ij} \\cdot bandInt\_{ij} + b\_{0i} + b\_{1i} \\cdot bandInt\_{ij} + \\epsilon\_{ij} \\end{equation}\\\]

[![](md_extract/assets/fig-e3-test-vx-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e3-test-vx-1.png)

Figure 23: e3 testing x velocities. Translucent bands with dash lines indicate the correct range for each velocity band.

Table 15: Testing vx - Empirical Summary
...
Table 16: Experiment 3. Bayesian Mixed Model Predicting Vx as a function of condition (Constant vs. Varied) and Velocity Band
...
See [Table 16](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-e3-bmm-vx) for the full model results.
...
[![](md_extract/assets/fig-alm-diagram-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-alm-diagram-1.png)

Figure 24: The basic structure of the ALM model.

Table 17: ALM & EXAM Equations
...
DeLosh et al. ([1997](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#ref-deloshExtrapolationSineQua1997)) introduced the associative learning model (ALM), a connectionist model within the popular class of radial-basis networks. ALM was inspired by, and closely resembles Kruschke’s influential ALCOVE model of categorization ([Kruschke, 1992](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#ref-kruschkeALCOVEExemplarbasedConnectionist1992)).
...
See [Table 17](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#tbl-alm-exam) for a full specification of the equations that define ALM and EXAM.

### Model Fitting and Comparison

Following the procedure used by Mcdaniel et al. ([2009](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#ref-mcdanielPredictingTransferPerformance2009)), we will assess the ability of both ALM and EXAM to account for the empirical data when fitting the models to 1) only the training data, and 2) both training and testing data. Models were fit to the aggregated participant data by minimizing the root-mean squared deviation (RMSE). Because ALM has been shown to do poorly at accounting for human patterns extrapolation ([DeLosh et al., 1997](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript.html#ref-deloshExtrapolationSineQua1997)), we will also generate predictions from the EXAM model for the testing stage. EXAM which operates identically to ALM during training, but includes a linear extrapolation mechanism for generating novel responses during testing.
...
Table 19: Model Perforamnce - averaged over all X values/Bands. ME=Mean Average Error, RMSE = Root mean squared error.

|   Fit\_Method   |   Model   |  |   Constant   |  |  |   Varied   |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
|  |   ME   |   RMSE   |  |   ME   |   RMSE   |
...
[![](md_extract/assets/fig-model-preds-varied-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-model-preds-varied-1.png)

Figure 25: Varied Group - Mean Model predictions vs. observations

Table 20: Varied group - mean model predictions vs. observations. Extrapolation Bands are bolded. For each Modelling fitting and band combination, the model with the smallest residual is highlighted. Only the lower bound of each velocity band is shown (bands are all 200 units).
...
[![](md_extract/assets/fig-model-preds-constant-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-model-preds-constant-1.png)

Figure 26: Constant Group - Mean Model predictions vs. observations

Table 21: Constant group - mean model predictions vs. observations. The X values of Extrapolation Bands are bolded. For each Modelling fitting and band combination, the model with the smallest residual is highlighted. Only the lower bound of each velocity band is shown (bands are all 200 units).
...
[![](md_extract/assets/unnamed-chunk-59-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-59-1.png)

#### First vs. second half of testing stage

[![](md_extract/assets/unnamed-chunk-60-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-60-1.png)

#### Group Comparison for asymptote-starting performance

[![](md_extract/assets/unnamed-chunk-61-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-61-1.png)
...
[![](md_extract/assets/unnamed-chunk-62-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-62-1.png)

[![](md_extract/assets/unnamed-chunk-62-2.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-62-2.png)

[![](md_extract/assets/unnamed-chunk-62-3.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-62-3.png)

[![](md_extract/assets/unnamed-chunk-62-4.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-62-4.png)
...
[![](md_extract/assets/unnamed-chunk-63-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-63-1.png)

[![](md_extract/assets/unnamed-chunk-63-2.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-63-2.png)

##### Experiment 1 Testing - relative distances

[![](md_extract/assets/unnamed-chunk-64-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-64-1.png)
...
[![](md_extract/assets/unnamed-chunk-65-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-65-1.png)

##### Experimenet 1 - intermittent testing

[![](md_extract/assets/unnamed-chunk-66-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-66-1.png)
...
[![](md_extract/assets/unnamed-chunk-69-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-69-1.png)
...
[![](md_extract/assets/unnamed-chunk-70-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/unnamed-chunk-70-1.png)

#### Appendix - Project 2 - Experiment 1

##### Posterior Predictive Distributions

[![](md_extract/assets/fig-post-pred-dist-1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-post-pred-dist-1.png)

Figure 27: Posterior Predictive distributions for Absolute Deviance. Posterior Draws in Blue, colored lines are empirical data.

[![](md_extract/assets/fig-post-pred-vx-1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-post-pred-vx-1.png)

Figure 28: Posterior Predictive distributions for Vx. Posterior Draws in Blue, colored lines are empirical data.

##### Empirical vs. Predicted

[![](md_extract/assets/fig-empVsPred-1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-empVsPred-1.png)

Figure 29: Bayesian Mixed Model predictions vs. Empirical Predictions - X velocity

##### Different Aggregations

[![](md_extract/assets/fig-empirical-distGrp1-1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-empirical-distGrp1-1.png)

Figure 30: E1. Distribution of Vx at Participant level

[![](md_extract/assets/fig-empirical-distGrp2-1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-empirical-distGrp2-1.png)

Figure 31: E1. Distribution of Vx at Trial level

[![](md_extract/assets/fig-e1-ame-1-1.png)](https://tegorman13.github.io/Dissertation/Manuscript/output/manuscript_files/figure-html/fig-e1-ame-1.png)

Figure 32: E1. Predicted Means Per Condition and Band, and Average Marginal Effect (Constant - Varied)