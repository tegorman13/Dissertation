...
```{r}
#| label: fig-post-pred-dist
#| fig-cap: Posterior Predictive distributions for Absolute Deviance. Posterior Draws in Blue, colored lines are empirical data. 
#| fig-width: 11
#| fig-height: 9
...
```{r}
#| label: fig-post-pred-vx
#| fig-cap: Posterior Predictive distributions for Vx. Posterior Draws in Blue, colored lines are empirical data. 
#| fig-width: 11
#| fig-height: 7
vx_pred <- 
...
```{r}
#| label: fig-empirical-distGrp1
#| fig-cap: E1. Distribution of Vx  at Participant level
#| fig-width: 12
#| fig-height: 10
...
```{r}
#| label: fig-empirical-distGrp2
#| fig-cap: E1. Distribution of Vx at Trial level
#| fig-width: 12
#| fig-height: 10
epTrial <- dist_pred  |>
  filter(iter < 2)  |> group_by(id,condit,vb) |>
