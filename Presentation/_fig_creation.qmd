...
igas_e1
ggsave(here::here("Presentation/assets/igas_e1_manip.png"), igas_e1, width = 7.0, height = 6, units = "in", dpi = 400)
...
create_data <- function(varied_train, constant_train1, constant_train2, constant_train3, constant_train4, constant_train5, constant_train6, both_test) {
    varied_labels <- "Varied-Train"
...
create_plot <- function(varied_train, constant_train1, constant_train2, constant_train3, constant_train4, constant_train5, constant_train6, both_test) {
    data <- create_data(varied_train, constant_train1, constant_train2, constant_train3, constant_train4, constant_train5, constant_train6, both_test)
    segments <- create_segments(data)
...
both_test <- c(1, 2, 3, 4, 5, 6) # Specify test positions
igas_e2 <- create_plot(varied_train, constant_train1, constant_train2, constant_train3, constant_train4, constant_train5, constant_train6, both_test)
igas_e2

ggsave(here::here("Presentation/assets/igas_e2_manip.png"), igas_e2, width = 7.5, height = 8, units = "in", dpi = 600)
